...
import 'package:pharma_go_v2_app/client/providers/ocr_provider/ocr_provider.dart';
import 'package:pharma_go_v2_app/client/providers/time_provider/time_provider.dart';
  ...
  Future<Map<String, dynamic>> createMedicineIDMap() async {
    ...
    try {
      ...
      for (var map in listOfMaps) {
        ...
        String dosage = map['dosage'].toString();
        String days = map['days'].toString();
